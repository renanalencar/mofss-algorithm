...
public class GeneralizedSpread {
  ...
  public double generalizedSpread(double [][] paretoFront,
    ...
    for (int i = 0; i < numberOfObjectives; i++) {
      Arrays.sort(normalizedParetoFront,new hidra.qualityIndicator.util.ValueComparator(i));
    ...
    Arrays.sort(normalizedFront,new hidra.qualityIndicator.util.LexicoGraphicalComparator());
