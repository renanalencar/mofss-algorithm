...
import hidra.many.metaheuristics.smopsomdfa.SMPSOMDFA;
import hidra.many.metaheuristics.smopsomdfa.SMPSOMDFAv2;
import hidra.many.metaheuristics.smopsomdfa.SMPSOMDFAv3;
...
public class HIDRA_SMPSOMDFAv3_Settings extends HIDRASettings{
	 ...
	 * Constructor
	 */
	public HIDRA_SMPSOMDFAv3_Settings(String problem) {
		super(problem) ;
	...
	public Algorithm configure() throws JMException {
		...
		algorithm = new SMPSOMDFAv3(problem_) ;
