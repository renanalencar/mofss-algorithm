...
import hidra.many.metaheuristics.smpsocdrgdr.SMPSOCDRGDR;
...
public class HIDRA_SMPSOCDRGDR_Settings extends HIDRASettings {
	 ...
	 * Constructor
	 */
	public HIDRA_SMPSOCDRGDR_Settings(String problem) {
		super(problem) ;
	...
	public Algorithm configure() throws JMException {
		...
		algorithm = new SMPSOCDRGDR(problem_) ;
