...
import hidra.many.metaheuristics.smpsoms.SMPSOMS;
...
public class HIDRA_SMPSOMS_Settings extends HIDRASettings {
	 ...
	 * Constructor
	 */
	public HIDRA_SMPSOMS_Settings(String problem) {
		super(problem) ;
	...
	public Algorithm configure() throws JMException {
		...
		algorithm = new SMPSOMS(problem_) ;
