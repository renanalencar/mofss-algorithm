...
import hidra.metaheuristics.mopsocdls.MOPSOCDLS;
 ...
 */
public class HIDRA_MOPSOCDLS_Settings extends HIDRASettings{
	   ...
	   * Constructor
	   */
	  public HIDRA_MOPSOCDLS_Settings(String problem) {
	  ...
	  public Algorithm configure() throws JMException {
	    ...
	    algorithm = new MOPSOCDLS(problem_) ;
