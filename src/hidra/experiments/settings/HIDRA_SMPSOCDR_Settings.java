...
import hidra.many.metaheuristics.smpsocdr.SMPSOCDR;
...
public class HIDRA_SMPSOCDR_Settings extends HIDRASettings{
	   ...
	   * Constructor
	   */
	  public HIDRA_SMPSOCDR_Settings(String problem) {
	    super(problem);
	  ...
	  public Algorithm configure() throws JMException {
	    ...
	    algorithm = new SMPSOCDR(problem_) ;
