 ...
 */
public abstract class HIDRASettings {
	 ...
	 * Constructor
	 */
	public HIDRASettings() {
	} // Constructor

	/**
	 * Constructor
	 */
	public HIDRASettings (String problemName) {
	...
	public final Algorithm configure(HashMap settings) throws JMException, IllegalArgumentException, IllegalAccessException, ClassNotFoundException {
		if (settings != null) {
			...
			pathRefHypervolume_ = (String)settings.get("pathRefHypervolume_");
			patternProblem_ = (String)settings.get("patternProblem_");
		}
