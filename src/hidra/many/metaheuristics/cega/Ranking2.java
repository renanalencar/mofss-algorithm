...
public class Ranking2 {
   ...
   */
  private static final Comparator dominance_ = new DominanceComparator2();
   ...
   */       
  public Ranking2(SolutionSet solutionSet) {        
    solutionSet_ = solutionSet ;

    // dominateMe[i] contains the number of solutions dominating i  
    
    if(solutionSet_.size() == 0)
    	throw new RuntimeException("Error solutionSet_ is empty");
