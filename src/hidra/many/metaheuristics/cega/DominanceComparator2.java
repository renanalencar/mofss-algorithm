 ...
 */
public class DominanceComparator2 implements Comparator{
	  ...
	  */
	  public int compare(Object object1, Object object2) {
	    ...
	    for (int i = 0; i < solution1.numberOfObjectives(); i++) {
	      ...
	      if (   (value1 - value2) < 0  &&  Math.abs((value1 - value2)) > 0.00000001) {
	        flag = -1;
	      } else if ( (value1 - value2) > 0  &&  Math.abs((value1 - value2)) > 0.00000001) {
	        flag = 1;
	      } else {
	        flag = 0;
	      }
