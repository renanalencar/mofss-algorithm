 ...
 */
public class SMPSOGDR extends HIDRAPopulationAlgorithm {
 ...
 // private int maxIterations_;
   ...
   */
  private Comparator comparatorGlobalDetriment_;
   ...
   */
  public SMPSOGDR(Problem problem) {
    super(problem) ;
  ...
  public void initParams() {
    ...
    comparatorGlobalDetriment_ = new GDComparator();
  ...
  private void computeSpeed(int iter, int miter) throws JMException {
    ...
    for (int i = 0; i < swarmSize_; i++) {
      ...
      if (comparatorGlobalDetriment_.compare(one, two) > 0 ) {
