 ...
 *     
 *     SEM MOVIMENTO COLETIVO INSTINTIVO (todas as part�culas s�o sempre movimentadas)
 *     # atualiza��o do STEP de forma diferente do original FSS
 * 
 */
public class MOFSSv6 extends Algorithm {
  ...
  public MOFSSv6(Problem problem) {
    super (problem) ;
