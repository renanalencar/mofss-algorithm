...
import hidra.many.metaheuristics.cega.Ranking2;
...
public class SMPSOMDFAv2 extends HIDRAPopulationAlgorithm{	
	 /**
	 ...
	 // private int maxIterations_;
	   ...
	   */
	  public SMPSOMDFAv2(Problem problem) {
	    super(problem) ;
	  ...
	  public void initParams() {
	    ...
	    this.mdfaFitness = new MDFAFitness(weights);
	    
	    leaders_ = new SolutionSet(archiveSize_ + swarmSize_);
	...
	*/  
	  ...
	  protected SolutionSet getParetoFront() {
		Ranking2 ranking2 = new Ranking2(this.leaders_);
	  ...
	  protected SolutionSet runIteration() throws JMException {
			  ...
			  leaders_.sort(comparatorMDFA_);
			  
			  while(leaders_.size() > archiveSize_){
				  leaders_.remove(0);
			  }
