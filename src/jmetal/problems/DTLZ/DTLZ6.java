 ...
 */
 public class DTLZ6 extends DTLZ{
	 ...
	 public DTLZ6(String solutionType,Integer numberOfObjectives) throws ClassNotFoundException {
  ...
  */      
  ...
  public double getRefHypervolume() {

		Double hypervolume = null;
		
		switch (Paramenters.NOBJ) {

		case 3: hypervolume = 0.09560996920336241; 		
		break;

		case 5: hypervolume = 0.035389289764314796;
		break;

		default: throw new RuntimeException("Hypervolume not defined");
