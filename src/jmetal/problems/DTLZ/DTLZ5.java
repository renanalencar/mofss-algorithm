...
public class DTLZ5 extends DTLZ{
	  ...
	  public DTLZ5(String solutionType,Integer numberOfObjectives) throws ClassNotFoundException {
  ...
  */      
  public void evaluate(Solution solution) throws JMException {
    ...
    boolean flag = false;
    for (int i = 0; i < numberOfObjectives_; i++){
    	if(Double.isInfinite(solution.getObjective(i))  || Double.isNaN(solution.getObjective(i)) ){
    		flag = true;
    		System.out.println();
    	}
    }
